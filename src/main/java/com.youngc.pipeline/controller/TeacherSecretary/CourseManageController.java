...
public class CourseManageController {
    ...
    @ResponseBody
    public Result selectCourseByCollege(@RequestParam String collegeNumber){
        return ResultGenerator.generate(ResultCode.SUCCESS, courseManageService.getCouseByCollegeNumber(collegeNumber));

    }

    @RequestMapping(path = "/selectCourseByMajorNumber", method = RequestMethod.GET)
    @ResponseBody
    public Result selectCourseByMajorNumber(@RequestParam String collegeNumber,@RequestParam String majorNumber){
        return ResultGenerator.generate(ResultCode.SUCCESS,courseManageService.getCourseByMajorNumber(collegeNumber,majorNumber));
